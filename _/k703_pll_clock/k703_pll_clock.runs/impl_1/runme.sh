...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k703_pll_clock/k703_pll_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pll_clock.tcl -notrace
