...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k709_hdmi_output_test/k709_hdmi_output_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_encoder_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_encoder_top.tcl
