...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k705_fifo_ila_debug/k705_fifo_ila_debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ila_debug.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_ila_debug.tcl
