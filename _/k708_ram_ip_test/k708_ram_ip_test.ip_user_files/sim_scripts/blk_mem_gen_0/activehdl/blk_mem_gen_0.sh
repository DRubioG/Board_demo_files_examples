...
#
# Generated by Vivado on Sat Jun 27 13:04:41 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Administrator/Desktop/K7325/DEMO/k708_ram_ip_test/k708_ram_ip_test.cache/compile_simlib/activehdl"
  fi
