...
read_verilog -library xil_defaultlib C:/Users/Administrator/Desktop/K7325/DEMO/k706_single_to_diff/k706_single_to_diff.srcs/sources_1/new/single_to_diff.v
...
set_property used_in_implementation false [get_files C:/Users/Administrator/Desktop/K7325/DEMO/k706_single_to_diff/k706_single_to_diff.srcs/constrs_1/new/single_to_diff.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top single_to_diff -part xc7k325tffg676-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef single_to_diff.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file single_to_diff_utilization_synth.rpt -pb single_to_diff_utilization_synth.pb"
