...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k704_iic_eeprom/k704_iic_eeprom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iic_eeprom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iic_eeprom.tcl
