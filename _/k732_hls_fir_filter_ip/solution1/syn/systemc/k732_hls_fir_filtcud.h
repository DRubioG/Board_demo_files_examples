...
// ==============================================================
#ifndef __k732_hls_fir_filtcud__HH__
#define __k732_hls_fir_filtcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(k732_hls_fir_filtcud) {
    ...
    SC_CTOR(k732_hls_fir_filtcud):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
