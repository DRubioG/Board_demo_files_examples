...
set ID 3
set hasByteEnable 0
set MemName k732_hls_fir_filtbkb
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_fir_time \
    op interface \
    ports { fir_time { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_result_valid \
    op interface \
    ports { result_valid { O 8 vector } } \
} "
}
