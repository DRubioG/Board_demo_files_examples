...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k717_ddr3_axi_read_write/k717_ddr3_axi_read_write.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_read_write.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_read_write.tcl
