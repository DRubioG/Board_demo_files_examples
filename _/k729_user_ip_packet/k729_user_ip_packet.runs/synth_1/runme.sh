...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k729_user_ip_packet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_ip_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_ip_test.tcl
