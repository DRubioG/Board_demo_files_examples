...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k729_user_ip_packet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log user_ip_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source user_ip_test.tcl -notrace
