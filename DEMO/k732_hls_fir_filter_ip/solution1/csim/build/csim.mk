...
HLS_SOURCES = ../../../tb_main.cpp ../../../k732_hls_fir_filter_ip.cpp
...
$(ObjDir)/k732_hls_fir_filter_ip.o: ../../../k732_hls_fir_filter_ip.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../k732_hls_fir_filter_ip.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/k732_hls_fir_filter_ip.d
