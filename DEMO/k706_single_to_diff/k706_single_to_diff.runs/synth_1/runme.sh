...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k706_single_to_diff/k706_single_to_diff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_to_diff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_to_diff.tcl
