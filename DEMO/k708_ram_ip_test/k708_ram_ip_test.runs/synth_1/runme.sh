...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k708_ram_ip_test/k708_ram_ip_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_ip_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_ip_top.tcl
