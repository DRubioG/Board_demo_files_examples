...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k708_ram_ip_test/k708_ram_ip_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_ip_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_ip_top.tcl -notrace
