...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k704_iic_eeprom/k704_iic_eeprom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iic_eeprom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iic_eeprom.tcl -notrace
