...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k729_user_ip_packet.runs/breath_led_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breath_led_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breath_led_0.tcl
