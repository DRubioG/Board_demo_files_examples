...
#
# Generated by export_simulation on Sun Jun 28 20:34:34 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './breath_led_0.sh' script.

./breath_led_0.sh -reset_run
...
./breath_led_0.sh -noclean_files

For more information on the script, please type './breath_led_0.sh -help'.
