...
#
# Generated by export_simulation on Sat Mar 21 22:12:54 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './vga_top_0.sh' script.

./vga_top_0.sh -reset_run
...
./vga_top_0.sh -noclean_files

For more information on the script, please type './vga_top_0.sh -help'.
