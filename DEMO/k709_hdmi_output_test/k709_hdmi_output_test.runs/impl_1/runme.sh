...
HD_PWD='C:/Users/Administrator/Desktop/K7325/R5/k709_hdmi_output_test/k709_hdmi_output_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_encoder_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_encoder_top.tcl -notrace
