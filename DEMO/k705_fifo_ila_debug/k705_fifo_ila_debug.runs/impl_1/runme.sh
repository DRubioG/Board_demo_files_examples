...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k705_fifo_ila_debug/k705_fifo_ila_debug.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ila_debug.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_ila_debug.tcl -notrace
