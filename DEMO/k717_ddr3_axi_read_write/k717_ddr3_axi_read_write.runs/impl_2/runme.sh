...
HD_PWD='C:/Users/Administrator/Desktop/K7325/DEMO/k717_ddr3_axi_read_write/k717_ddr3_axi_read_write.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_read_write.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ddr3_read_write.tcl -notrace
